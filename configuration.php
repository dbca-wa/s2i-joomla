...
class JConfig
{
	...
	public $sitename = _ENV["sitename"];            // Name of Joomla site
	public $editor = _ENV["editor"];
	public $captcha = '0';
	...
	/* Database Settings */
	public $dbtype = _ENV["dbtype"];               // Normally mysqli
	public $host = _ENV["host"];              // This is normally set to localhost
	public $user = _ENV["user"];                       // DB username
	public $password = _ENV["password"];                   // DB password
	public $db = _ENV["db"];                         // DB database name
	public $dbprefix = 'jos_';               // Do not change unless you need to!

	/* Server Settings */
	public $secret = _ENV["secret"];     // Change this to something more secure
	public $gzip = '0';
	...
	public $live_site = _ENV["live_site"];                   // Optional, full URL to Joomla install.
	...
	public $mailonline = '1';
	public $mailer      = 'mail';
	public $mailfrom    = _ENV["mailfrom"];
	public $fromname    = _Email["fromname"];
